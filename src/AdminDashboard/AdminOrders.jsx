...
const AdminOrders = () => {
    ...
    const fetchorders = async () => {
        setloading(true);
        try {
            const res = await axios.get(`http://localhost:8080/api/orders/admin/getallorders`, { withCredentials: true })
            setorders(res.data)
    ...
    const updateStatus = async (orderId, status) => {
        try {
            await axios.put(`http://localhost:8080/api/orders/admin/updateorderstatus/${orderId}`,
                { status },
